#random forest, GBM, XGBoost, LightGBM, CarBoost
...
#hata oranı daha düşük olmazsa
#ön tanımlı argüman arama setinde olmayabilir
#rastgelelikten olabilir
...
plot_importance(rf_final,X) #değişkenler ve önem düzeyleri
...
val_curve_params(rf_final,X,y,"max_depth",range(1,11),scoring="roc_auc") #max derinliğe göre değerlendirme
...
#importance skor 0 civari olanlarla igilenmeyiz, süreci uzatır.
